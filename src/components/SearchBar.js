  ...
  return (
    <div ref={ref} style={{ position:"relative", width:260 }}>
      <div style={{ position:"relative" }}>
        ...
        />
        {q && (
          <button onClick={() => { setQ(""); setIsOpen(false); }}
            style={{ position:"absolute", right:9, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", cursor:"pointer", color:C.t2, fontSize:13 }}>✕</button>
        )}
      </div>
      <AnimatePresence>
